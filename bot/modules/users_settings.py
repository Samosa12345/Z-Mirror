...
async def update_user_settings(query):
    ...
    if not ospath.exists(tpath):
        tpath = "https://telegra.ph/file/cd0d8a8fd27d2a7ae87dd.jpg"
...
Examples:
1. <code>{escape('<b>Join: @THE_SILENT_TEAMS</b>')}</code> 
This will give output as:
<b>Join: @THE_SILENT_TEAMS</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @THE_SILENT_TEAMS</code>')}</code> 
This will give output as:
<code>Join: @THE_SILENT_TEAMS</code> <code>69MB.bin</code>.
